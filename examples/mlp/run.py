"""Full FHE pipeline for MLP on MNIST.

Compile -> keygen -> encrypt -> evaluate -> decrypt -> print MAE.

Usage: cd examples/mlp && python run.py
"""
...
def main():
    ...
    # 3. Compile
    # MLP: Flatten -> FC(784,128) -> BN -> Quad -> FC(128,128) -> BN -> Quad -> FC(128,10)
    # Needs enough levels for all multiplications in the chain
